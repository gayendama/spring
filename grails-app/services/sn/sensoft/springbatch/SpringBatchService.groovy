...
class SpringBatchService implements ApplicationListener<ApplicationEvent> {
    ...
    JobExecution restart(Long jobExecutionId) {
        JobExecution jobExecution = jobService.restart(jobExecutionId)
        return jobExecution
    }
    ...
    void stopAllJobExecutions(String jobName) {
        ...
        executions.each {
            try {
                ...
                log.error((JsonOutput.toJson([method: "stopAllJobExecutions", message: e.message])))
            }
        }
    }
    ...
    Map launch(String jobName, boolean canBeConcurrent = true, JobParameters jobParams = null, String jobLauncherName = null) {
        ...
        return [
            ...
            jobInstanceId: jobExecution.jobInstance.instanceId,
