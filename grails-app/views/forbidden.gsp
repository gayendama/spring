...
<head>
    <meta charset="utf-8"/>
    <title>Erreur! Non autorisé</title>
                            ...
                            <div class="page-content-inner">
                                <div class="row">
                                    <div class="col-md-12 page-403">
                                        ...
                                        <div class="details">
                                            <h3>Erreur! Accés refusé.</h3>

                                            <p>Vous n'êtes pas autorisé(e) à  accéder à cette page. Veuillez vous rapprocher de votre administrateur
                                                <br/>
                                                <br/>
