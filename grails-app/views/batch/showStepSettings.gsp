...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'batchJob.label', default: 'Batch')}"/>
                                            ...
                                            <div class="portlet-body">
                                                <div class="table-container">
                                                    ...
                                                    <div id="programmeTable">
                                                        ...
                                                        <asset:stylesheet src="lc_switch.css"/>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover dt-responsive"
                                                            ...
                                                            <thead>
                                                            <tr>
                                                                <g:sortableColumn property="sequenceNumbe" title="SEQUENCE"/>
                                                            ...
                                                            <g:each in="${programmeBatchList}" status="i" var="step">
                                                                <tr>
                                                                    <td>${fieldValue(bean: step, field: "sequenceNumber")}</td>
                                                                    <td>${fieldValue(bean: step, field: "codeProgramme")}</td>
                                                                    <td>
                                                                        <g:message code="batch.step.${step.nomProgramme}" default="${step.nomProgramme}"/>
                                                                    </td>
                                                                    <!-- td align="center">
                                                                        ...
                                                                        <div id="${i}-edit-seq-div" style="display: none" class="edit-step-div">
                                                                            <input id="${i}-input-seq" type="number" min="1" class="seq-input form-control input-inline" value="${fieldValue(bean: step, field: "sequenceNumber")}" onkeyup="onKeyPress(${i})" />
                                                                    ...
                                                                    <td align="center" valign="center">
                                                                        ...
                                                                        <script>
                                                                            $('body').delegate('#${i}-switch', 'lcs-statuschange', function () {
                                                                                if (($('#${i}-switch').is(':checked'))) {
                                                                                    updateStep(${i}, "${sn.sensoft.springbatch.utils.BatchStepStatus.ACTIVER.id}")
                                                                                } else {
                                                                                    updateStep(${i}, "${sn.sensoft.springbatch.utils.BatchStepStatus.DESACTIVER.id}")
                                                                                }
                                                                            });
                                                                        </script>
                                                                    </td>
...
<script>
    ...
    function updateStep(num, status) {
        $("#" + num + "-spinner").css("display", "block");
        json = {idStep: $("#" + num + "-input-step-id").val(), status: status};
        $.ajax({
            url: '${request.contextPath}/batch/updateStepStatus',
            type: 'POST',
            dataType: 'html',
            contentType: 'application/json',
            success: function (data) {
                ...
                setTimeout(function () {
                    // if(($('#'+num+'-switch').is(':checked'))){
                    //     $( "#"+num+"-switch" ).lcs_off();
                    // }else{
                    //     $( "#"+num+"-switch" ).lcs_on();
                    // }
                    $("#" + num + "-spinner").css("display", "none");
