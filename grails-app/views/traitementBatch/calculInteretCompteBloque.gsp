...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'interetCompteBloque.label', default: 'Intérêt compte bloqué')}"/>
                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet box green">
                                                <div class="portlet-title">
                                                    ...
                                                    <div class="actions">
                                                        <g:actionSubmit action="launchCalculInteretCompteBloque"
    ...
    function displayCompteCible(){
        ...
        if (compteCible != "") {
            ...
            $.ajax({
                type: 'POST',
                processData: true,
                url: '${request.contextPath}/traitementBatch/renderCompteCible',
                data: {
