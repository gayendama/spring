...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'correection.fraisTenuCompte', default: 'Correction frais tenu de compte')}"/>

    <title><g:message code="correection.fraisTenuCompte" default="Correction frais tenu de compte" /></title>
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        <div class="container">
                                    ...
                                    %{--<sec:ifAnyGranted
                                        ...
                                        <li>
                                            <g:link action="index">
                                                ...
                                                <g:message code="correection.fraisTenuCompte" default="Correction frais tenu de compte"/>
                                            </g:link>
                                            <i class="fa fa-circle"></i>
                                        </li>
                                    %{--</sec:ifAnyGranted>--}%
                            ...
                            <div class="row">
                            <!-- BEGIN FORM-->
                                <g:form role="form" method="POST" controller="batch" class="form-horizontal">
                                    <div class="col-md-12">
                                        <div class="portlet box green">
                                            <div class="portlet-title">
                                                ...
                                                <div class="actions">
                                                    <g:actionSubmit action="launchCorrectionFraisTcp"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-offset-1 col-md-4">
                                                            <div class="form-group form-md-line-input form-md-floating-label has-info">
                                                                <label
                                                                        for="moisConcerne"><g:message
                                                                        code="moisConcerne.label"
                                                                        default="Mois Concerné"/>
                                                                    <span class="required">*</span>
                                                                </label>

                                                                <input type="text" name="moisConcerne"
                                                                       id="moisConcerne" value=""
                                                                       required="required"
