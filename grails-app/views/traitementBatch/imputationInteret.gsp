...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'interet.imputationInteret', default: 'Imputation intérêt')}"/>
    <g:set var="entityName2" value="${message(code: 'traitementBatch.label', default: 'Traitement bacth')}"/>

    <title><g:message code="interet.imputationInteret" args="[entityName]"/></title>
                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet box green">
                                                <div class="portlet-title">
                                                    ...
                                                    <div class="actions">
                                                        <g:actionSubmit action="launchImputationInteret"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-offset-1 col-md-4">
                                                                <div class="form-group form-md-line-input form-md-floating-label has-info">
                                                                    <label for="compteCible">
                                                                        <g:message code="interet.compteCible"
                                                                                   default="Nombre de compte"/>

                                                                        <span class="required">*</span>
                                                                    </label>

                                                                    <g:select class="form-control select2" name="compteCible" id="compteCible" from="${['C', 'B']}"
                                                                              valueMessagePrefix="interet.cible" onchange="displayCompteCible()"
                                                                              noSelection="['': '- Choix compte -']" required="true"/>
...
<script>
    function displayCompteCible(){
        var compteCible = $("#compteCible").val();

        if (compteCible != "") {
            showSpinner('Chargement en cours ...')
            $.ajax({
                type: 'POST',
                processData: true,
                url: '${request.contextPath}/traitementBatch/renderCompteCibleImputationInteret',
                data: {
