...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'apurementCompteGestion.label', default: 'Apurement compte gestion')}"/>
                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet box green">
                                                <div class="portlet-title">
                                                    ...
                                                    <div class="actions">
                                                        <g:actionSubmit action="launchApurementCompteGestion"
