...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'creancesRattachees.label', default: 'Créances rattachées')}"/>
                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet box green">
                                                <div class="portlet-title">
                                                    ...
                                                    <div class="actions">
                                                        <g:actionSubmit action="launchCalculCreancesRatachees"
                                                    ...
                                                    %{--<div class="form-actions">--}%
                                                        %{--<div class="row">--}%
                                                            %{--<div class="col-3-button">--}%
                                                                        %{--<g:actionSubmit--}%
                                                                                %{--action="calculerCreanceRattachee"--}%
