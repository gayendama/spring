...
<head>
    ...
    <g:set var="entityName"
           value="${message(code: 'calculImmo.generationEcritureImmobilisation', default: 'Comptabilisation des Immobilisations')}"/>



    <title><g:message code="calculImmo.generationEcritureImmobilisation"/></title>
                        ...
                        <div class="container">
                            ...
                            <div style="display: block; padding-bottom: 5px;">
                                ...
                                <ul class="page-breadcrumb breadcrumb">
                                    ...
                                    <sec:ifAnyGranted roles="${toolsService.getRoleSubMenu("/comptaImmo/index")}">
                                        <li>
                                            <g:link action="index">
                                    ...
                                    <li>
                                        ...
                                        <g:message code="calculImmo.generationEcritureImmobilisation" args="[entityName]"/>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        ...
                                                        <span class="caption-subject bold uppercase"><g:message
                                                                code="calculImmo.generationEcritureImmobilisation"
                                                                args="[entityName]"/></span>
                                                    </div>

                                                    <div class="actions">
                                                        <g:actionSubmit name="create" action="launchComptaImmo"
...
<script>
    function traitementModal() {
        ...
        if (jQuery('#dateArrete').val()) {
            jQuery.modal({
                content: '<p class="colx2-center "><h1> <blink> ${message(code: 'traitement.calculImmo.message', default: 'Traitement du calcul des immobilisations en cours !')} </blink></h1></p>' +
                    '<br><br>' +
                    '<div class="columns"><p class="colx0-left"><img id="img-spinner" src="${resource(dir:'images',file:'batch.gif')}" alt="Loading"/></p>' +
                    '<p class="colx2-left full-width"> <H2>${message(code: 'traitement.calculImmo.messageAttente', default: 'Veuillez patienter pendant le calcul des immobilisations...')} </H2>  </p></div>',
                title: 'Traitement...',
                maxWidth: 500,
                buttons: {
