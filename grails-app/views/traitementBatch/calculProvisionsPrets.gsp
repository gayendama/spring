...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'traitementBatch.calculProvisionsPrets', default: 'Calcul provisions prets')}"/>

    <title><g:message code="traitementBatch.calculProvisionsPrets" /></title>
                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet box green">
                                                <div class="portlet-title">
                                                    ...
                                                    <div class="actions">
                                                        <g:actionSubmit action="launchCalculProvisionsPrets"
