...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'calculImmo.label', default: 'CalculImmo')}"/>
    <g:set var="entityNames" value="${message(code: 'calculImmos.label', default: 'CalculImmo')}"/>
                        ...
                        <div class="container">
                            ...
                            <div style="display: block; padding-bottom: 5px;">
                                ...
                                <ul class="page-breadcrumb breadcrumb">
                                    ...
                                    <sec:ifAnyGranted roles="${toolsService.getRoleSubMenu("/calculImmo/index")}">
                                        <li>
                                            <g:link action="index">
                                    ...
                                    <li>
                                        ...
                                        <g:message code="calculImmo.label" args="[entityName]"/>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        ...
                                                        <span class="caption-subject bold uppercase"><g:message
                                                                code="calculImmo.label"
                                                                args="[entityName]"/></span>
                                                    </div>

                                                    <div class="actions">
                                                        <g:actionSubmit name="create" action="launchCalculImmo"
