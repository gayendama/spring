...
<head>
    <meta charset="utf-8"/>
    <g:set var="entityName" value="${message(code: 'ecritureProvision.label', default: 'Ecritures provision')}"/>
    <g:set var="entityName2" value="${message(code: 'traitementBatch.label', default: 'Traitement bacth')}"/>

    <title><g:message code="default.generation.label" args="[entityName]"/></title>
                            ...
                            <div style="display: block; padding-bottom: 5px;">
                                ...
                                <ul class="page-breadcrumb breadcrumb">
                                    ...
                                    <li>
                                        ...
                                        <g:message code="default.generation.label" args="[entityName]"/>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        ...
                                                        <span class="caption-subject bold uppercase"><g:message
                                                                code="default.generation.label"
                                                                args="[entityName]"/></span>
                                                    </div>

                                                    <div class="actions">
                                                        <g:actionSubmit action="launchGenerationEcritureProvision"
