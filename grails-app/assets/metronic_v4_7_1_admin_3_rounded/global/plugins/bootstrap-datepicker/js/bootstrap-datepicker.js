 ...
 */(function(factory){
      ...
      var element = this.component ? this.element.find('input') : this.element;
		...
		fill: function(){
			var d = new Date(this.viewDate),
				...
				titleFormat = dates[this.o.language].titleFormat || dates['fr'].titleFormat,
				tooltip;
        ...
        nextMonth.setUTCFullYear(prevMonth.getUTCFullYear());
			...
			var monthsTitle = dates[this.o.language].monthsTitle || dates['fr'].monthsTitle || 'Mois';
	...
	var dates = $.fn.datepicker.dates = {
		...
		fr: {
			...
			months: ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "December"],
			monthsShort: ["Jan.", "Fév.", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Sep.", "Oct.", "Nov.", "Dec."],
			today: "Aujourd'hui",
			clear: "Clear",
			titleFormat: "MM yyyy"
		}
