...
!function (e) {
    ...
    s.toolbox = {
        ...
        feature: {
            mark: {
                show: !1,
                title: {mark: "Place Marker", markUndo: "Undo Marker", markClear: "Clear Marker"},
                lineStyle: {width: 1, color: "#1e90ff", type: "dashed"}
            },
            dataZoom: {show: !1, title: {dataZoom: "Zoom", dataZoomReset: "Reset Zoom"}},
            magicType: {
                show: !1,
                title: {
                    line: "Line Chart",
            ...
            restore: {show: !1, title: "Restore"},
            saveAsImage: {show: !1, title: "Save Image", type: "png", lang: ["Save"]}
        }
    };
