...
@Slf4j
public class ItemWriterRepriseSync implements ItemWriter<ItemToProcess> , StepExecutionListener{
        ...
        if (items != null){
            items.each {ItemToProcess itemToProcess ->
                ...
                executor.execute(){
                    ...
                    HttpResponse<SimpleResponse> httpResponse  = aichaClient.processItemReprise(apiManagerService.aichaBearerToken(), processRequest)
